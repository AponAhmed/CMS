...
CKEDITOR.plugins.add('acolumn', {
    ...
    icons: 'Column,Media,Canned,More,NewCanned',
    ...
    init: function(editor) {
        ...
        editor.addCommand('insertMedia', {
            ...
            exec: function(editor) {
                ...
                // alert(r);                
                $.fancybox.open({
                    src: 'index.php?w=850&h=500&c=forms&m=library&FieldId=mdInsSelectedCurrent&calback=insMedia&fancybox=true&instanse=' + currentInstance, // Source of the content
